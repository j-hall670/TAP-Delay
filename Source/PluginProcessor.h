...
/**
*/
class TAPDelayAudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    TAPDelayAudioProcessor();
    ~TAPDelayAudioProcessor() override;
...
private:
    ...
    int mSampleRate { 44100 }; // Global sample rate

    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TAPDelayAudioProcessor)
};
